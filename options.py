...
def get_parser():
    ...
    parser.add_argument("--config_file", default="resume.chinese-bert-wwm-ext.ner.yaml", type=str)
    ...
    parser.add_argument("--backbone", default='/home/yixin/huggingface/chinese-bert-wwm-ext', type=str)
